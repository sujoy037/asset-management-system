...
const EmployeeDashboard = () => {
  ...
  const cards = [
    ...
    { title: 'Assign Assets', path: '/employee-assign-asset', color: 'rgb(52, 152, 219)', Icon: WebAssetIcon },
    { title: 'Complaints', path: '/employee-complaints', color: 'rgb(231, 76, 60)', Icon: ReportProblemIcon },
    { title: 'Report', path: '/employee-reports', color: 'rgb(241, 196, 15)', Icon: SummarizeIcon },
    { title: 'History', path: '/employee-history', color: 'rgb(155, 89, 182)', Icon: HistoryIcon },
