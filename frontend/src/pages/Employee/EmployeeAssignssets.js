...
const EmployeeAssignssets = () => {
    ...
    // Define card data
    const cards = [
        { title: 'Employee Assets File Upload', path: '/employee-upload', color: 'rgb(46, 204, 113)', Icon: UploadFileIcon },
        { title: 'Employee Assets Assigned List ', path: '/employee-assets-assign-list-by-user', color: 'rgb(52, 152, 219)', Icon: HowToRegIcon },
        { title: 'Assign Assets', path: '/employee-create-assigned-asset', color: 'rgb(142, 68, 173)', Icon: EditIcon },
        { title: 'Asset Allocation Status', path: '/employee-status-assets-allocation', color: 'rgb(26, 188, 156)', Icon: MovingIcon },
    ];
...
export default EmployeeAssignssets;
